  ...
  return (
    <div className="flex gap-[1rem] max-lg:flex-wrap">
      {pricing.map((item) => (
        <div
          key={item.id}
          className="h-full w-[19-rem] rounded-[2rem] border border-n-6 bg-n-8 px-6 odd:py-8 odd:my-4 even:py-14 max-lg:w-full lg:w-auto [&>h4]:first:text-color-2 [&>h4]:even:text-color-1 [&>h4]:last:text-color-3"
        >
